...
protocol MovieService {
    ...
    func fetchGenres(successHandler: @escaping (_ response: GenresResponse) -> Void, errorHandler: @escaping(_ error: Error) -> Void)
    func discoverMovie(params: [String : String]?, successHandler: @escaping (MoviesResponse) -> Void, errorHandler: @escaping (Error) -> Void)
    
    func getMovieVideo(id: String, successHandler: @escaping (MovieVideoResponse) -> Void, errorHandler: @escaping (Error) -> Void)
    func getMovieReview(id: String, params: [String : String]?, successHandler: @escaping (MoviesReviewResponse) -> Void, errorHandler: @escaping (Error) -> Void)
}
